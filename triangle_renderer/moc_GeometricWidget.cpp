...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GeometricWidget_t, stringdata) + ofs \
...
const QMetaObject GeometricWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_GeometricWidget.data,
      qt_meta_data_GeometricWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GeometricWidget.stringdata))
